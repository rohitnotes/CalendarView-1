 ...
 *
 */
public class StyledGradientDrawable extends Drawable {
    /**
     ...
     */
    public StyledGradientDrawable(Orientation orientation, int[] colors) {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        TypedArray a = r.obtainAttributes(attrs,
                android.R.styleable.GradientDrawable);
    ...
    */
    ...
    final static class GradientState extends ConstantState {
        ...
        public Drawable newDrawable() {
            return new StyledGradientDrawable(this);
        }
    ...
    private StyledGradientDrawable(GradientState state) {
	 ...
	 * @param br
	 */
	public void setCornerRadii(boolean tl, boolean tr, boolean br, boolean bl){
		final float[] radii = new float[8];
		final float cornerSize = 1000f;
		
		radii[0] = tl ? cornerSize : 0;
		radii[1] = tl ? cornerSize : 0;
		
		radii[2] = tr ? cornerSize : 0;
		radii[3] = tr ? cornerSize : 0;
		
		radii[4] = br ? cornerSize : 0;
		radii[5] = br ? cornerSize : 0;
		
		radii[6] = bl ? cornerSize : 0;
		radii[7] = bl ? cornerSize : 0;
